...
namespace AppServiceTest.UI
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            if (args.Request.Message.ContainsKey("foruwp"))
            {
                var message = args.Request.Message["foruwp"].ToString();
                var messageDialog = new MessageDialog(message);
                messageDialog.Commands.Add(new UICommand("Close", OnClose));
        ...
        private void OnClose(IUICommand command)
        {
            // do nothing
        }
